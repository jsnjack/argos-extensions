...
echo "---"
echo "Assigned to me | href=https://github.com/surfly/it/issues/assigned/jsnjack"
echo "My prs| href=https://github.com/pulls?q=is%3Aopen+is%3Apr+author%3Ajsnjack+archived%3Afalse+user%3Asurfly"
echo "---"
